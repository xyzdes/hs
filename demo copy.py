...
if __name__ == '__main__':
    ...
    # usage demo
    lines = [
        "Hello Rashid, what you do do do dododo dodo",
        "I think we are in business now, Gill",
        "Now I just need to convert svg paths to gcode paths, and then",
        "I'll tell you how I became the prince of a town called Bel-Air",
    ]
    biases = [.75 for i in lines]
    styles = [9 for i in lines]
    stroke_colors = ['red', 'red', 'red', 'red']
